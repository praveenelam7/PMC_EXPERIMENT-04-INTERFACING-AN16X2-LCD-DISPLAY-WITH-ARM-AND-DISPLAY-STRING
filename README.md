...
{
    Lcd_cursor(&lcd, 0, 1);
    Lcd_string(&lcd, "PRAVEEN J");

    Lcd_cursor(&lcd, 1, 1);
    Lcd_string(&lcd, "212225220073");
}
...
<img width="1081" height="752" alt="image" src="https://github.com/user-attachments/assets/979f935f-2bdc-4a81-8b69-69874f95a0a2" />

 
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="1020" height="733" alt="image" src="https://github.com/user-attachments/assets/2e2cb6e9-6561-4331-91e8-92465610e034" />
